...
public class VentanaOperacion extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txtVariable, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int cont = 0;
        for (int i = 0; i < getP().getVariables().size(); i++) {
            if (getP().getVariables().get(i).getVariable().equals(txtVariable.getText())) {
                cont++;
            }
        }
        if (cont == 0) {
            ...
            op = new Operacion(txtVariable.getText(), txtOperacion.getText());
            op.setPosicion(getP().getPosicion());
            getP().setPosicion(getP().getPosicion() + 1);
            operaciones.add(op);
            getP().getFile().getOperacion().add(op);
            this.dispose();
            getP().setVisible(true);
            getP().setEnabled(true);
            //AGREGA EL TEXTO QUE VA A APARECER EN EL DIBUJO
            getP().iniciarFigura("proceso", ""+txtVariable.getText()+" = "+txtOperacion.getText());
        }else{
            JOptionPane.showMessageDialog(null, "digite la operación");
